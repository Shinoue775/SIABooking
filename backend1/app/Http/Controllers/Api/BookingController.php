    ...
    public function store(StoreBookingRequest $request, SupabaseService $supabase): JsonResponse
    {
        ...
        try {
            ...
            $bookingPayload = array_filter([
                ...
                'balance_due' => $payload['balance_due'] ?? max($payload['total_price'] - ($payload['amount_paid'] ?? 0), 0),
            ...
            // Surface Supabase/validation payload issues to the frontend for debugging.
            return response()->json([
