...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="p-6 sm:p-8 md:w-1/2">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
                  ...
                  <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-xs sm:text-sm font-semibold self-start sm:self-auto">
                    {roomData.A.type}
                  </span>
                </div>
      ...
      {isModalOpen && selectedRoom && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm transition-opacity duration-300">
          <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-300 scale-100 max-h-[90vh] overflow-y-auto">
            ...
            {/* Modal Header/Image */}
            <div className="relative h-48 sm:h-56 md:h-64 w-full bg-gray-900">
              <Image 
      ...
      <footer style={{ backgroundColor: '#e8cae4' }} className="text-gray-800 mt-12 sm:mt-16">
        <div className="container mx-auto px-4 max-w-7xl py-8 sm:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 sm:col-span-2 lg:col-span-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                />
                <div>
                  <h5 className="text-base sm:text-lg md:text-xl font-bold">Gordon College</h5>
                  <p className="text-xs sm:text-sm text-black-400">College of Hospitality and Tourism Management</p>
                </div>
              </div>
              <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-black-400">
            ...
            <div>
              ...
              <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-black-400">
                {['Home', 'Bookings', 'About Us', 'Contact'].map((item) => (
                  <li key={item}>
                    <Link 
                      href={item === 'Bookings' ? (isLoggedIn ? "/booking" : "/login") : (item === 'Home' ? "/" : "#")}
                      onClick={(e) => {
            ...
            <div className="col-span-1 sm:col-span-2 lg:col-span-1">
              ...
              <div className="flex space-x-3">
                <a href="#" className="bg-white/50 p-2 sm:p-3 rounded-lg hover:bg-gray-200 transition">
          ...
          <div className="border-t border-gray-300 mt-6 sm:mt-8 pt-6 sm:pt-8">
            <p className="text-xs sm:text-sm text-black-400 text-center">
