...
// GET /api/rooms/availability/month?year=YYYY&month=M&room_id=10|11
// Returns the day numbers (1–31) that are booked for the given room in the given month.
// room_id 10 = Standard, room_id 11 = Deluxe
export async function GET(request: Request) {
    ...
    try {
        ...
        // Fetch all non-cancelled bookings for the given room_id that overlap with this month:
