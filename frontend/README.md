...
- This project now uses `frontend/vercel.json` with `functions` pointing to `api/index.php` instead of legacy `builds`, so Vercel project build settings are no longer ignored.
